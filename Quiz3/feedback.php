  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00122.jpg" width=100 height=100 class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Aayushi Trivedi</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">12202040501002</h4>
		<h4 style="font-family:'typo' ">aayushitrivedi@gmail.com</h4>
		<h4 style="font-family:'typo' ">G H Patel College Of Engineering & Technology, VVN.</h4></div></div>
		</p>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00123.jpg" width=100 height=100 class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Aayushi Bhatt</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">12202040501010</h4>
		<h4 style="font-family:'typo' ">aayushibhatt323@gmail.com</h4>
		<h4 style="font-family:'typo' ">G H Patel College Of Engineering & Technology, VVN.</h4></div></div>
		</p>
      </div>
